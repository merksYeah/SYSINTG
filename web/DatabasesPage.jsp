<%-- 
    ...
    Created on : 08 13, 16, 10:01:54 PM
    Author     : migue
--%>
                       ...
                       <c:forEach items="${databases}" var="database">
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <div class="div-square">
                                 ...
                                 <div>
                                     <h4><c:out value="${database.databasename}"/></h4>
                                 </div>
                                 <div>
                                     <a href="toExportPage?databasename=<c:out value="${database.databasename}"/>">
                                          <button class="btn btn-success">EXPORT</button>
                                         
                                     </a>
                                     <a href="downloadDumpFile?databasename=<c:out value="${database.databasename}"/>">
