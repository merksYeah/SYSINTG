 ...
 * @author migue
 */
public class showWebServices extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<webService> webservices = parser.parseServiceOutput(getWebServiceStatus());
            request.setAttribute("webservices", webservices);
            rd = request.getRequestDispatcher("WebServicesPage.jsp");
    ...
    private String getWebServiceStatus() {
        ...
        return port.getWebServiceStatus();
    }
