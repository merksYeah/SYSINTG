...
import org.objects.memory;

/**
 *
 * @author migue
 */
public class loadMemoryUsageChart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String[] memoryUsage = retrieveMemoryUsage().split("\\r?\\n");
            memory mem = new memory();
            double freemem = Double.parseDouble(memoryUsage[0]) - Double.parseDouble(memoryUsage[1]);
            mem.setLabel(Double.parseDouble(memoryUsage[0]));
            mem.setY(freemem);
            String json = null;
            json=new Gson().toJson(mem); 
    ...
    private String retrieveMemoryUsage() {
        ...
        return port.retrieveMemoryUsage();
    }
