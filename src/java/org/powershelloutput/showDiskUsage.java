 ...
 * @author migue
 */
public class showDiskUsage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<logicalDisk> disks = parser.parseDiskOutput(retrieveFreeDiskSpace());
            request.setAttribute("disks", disks);
            rd = request.getRequestDispatcher("DiskUsagePage.jsp");
    ...
    private String retrieveFreeDiskSpace() {
        ...
        return port.retrieveFreeDiskSpace();
    }
