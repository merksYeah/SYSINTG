 ...
 * @author migue
 */
public class setServiceToStart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           startWebService(request.getParameter("serviceName"));
           rd = request.getRequestDispatcher("/showWebServices");
           rd.forward(request, response);
        } catch (IOException_Exception ex) {
            Logger.getLogger(setServiceToStart.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private String startWebService(java.lang.String serviceName) throws IOException_Exception {
        ...
        return port.startWebService(serviceName);
    }
