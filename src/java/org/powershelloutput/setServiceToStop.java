 ...
 * @author migue
 */
public class setServiceToStop extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           stopWebService(request.getParameter("serviceName"));
    ...
    private String stopWebService(java.lang.String serviceName) {
        ...
        return port.stopWebService(serviceName);
    }
