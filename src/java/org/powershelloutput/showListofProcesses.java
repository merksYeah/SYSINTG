 ...
 * @author migue
 */
public class showListofProcesses extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           ArrayList<computerProcess> processes = parser.parseProcessOutput(retrieveRunningProcesses());
           request.setAttribute("processes", processes);
           rd = request.getRequestDispatcher("ProcessesPage.jsp");  
    ...
    private String retrieveRunningProcesses() {
        ...
        return port.retrieveRunningProcesses();
    }
